...
/**
 * <p>Function: [功能模块：默认转置器，适用于按参数明细统计功能，直接返回第三个入参的值（String类型）]</p>
 * <p>Description: [功能描述：将方法的第三个入参转置为String后直接返回，参数为基础类型的可以使用此默认转置器]</p>
