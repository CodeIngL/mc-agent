 ...
 */
@Slf4j
public class OpmcDrivenBeanDefinitionParser implements BeanDefinitionParser {

    static final String OPMC_PACKAGE = "cn.com.servyou.yypt.opmc.agent.spring";
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        element.setAttribute("base-package", OPMC_PACKAGE);
