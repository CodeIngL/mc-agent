...
import com.codeL.mc.agent.fetch.annotation.define.*;
...
public class MetricsDelegate implements ApplicationListener {
     ...
     * 命名空间
     */
    private static final String MBEAN_NAMESPACE = "codeL";
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        if (event instanceof AvailableEvent) {
            registerGauge(Constants.METRICS_DYNAMIC_KEY, new Gauge() {
                @Override
                public Object getValue() {
