...
import com.codeL.mc.agent.conf.context.event.ApplicationEventMulticaster;
import com.codeL.mc.agent.event.AvailableEvent;
import com.codeL.mc.agent.event.UnavailableEvent;
...
import static com.codeL.mc.agent.config.ConfigurationStateHolder.ConfigurationState.UNAVAILABLE;
