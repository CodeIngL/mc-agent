package com.codeL.mc.agent.fetch.helper;

import com.codeL.mc.agent.conf.annotation.ConfigAnnotation;
import com.codeL.mc.agent.data.cache.DivideParamParserRegistry;
import com.codeL.mc.agent.data.key.KeyCache;
...
import static com.codeL.mc.agent.constant.McConfigConstants.CLASS_INTERNAL_DIVIDE_PARAM_PARSER_REGISTRY;
import static com.codeL.mc.agent.constant.McConfigConstants.CLASS_INTERNAL_KEY_CACHE_DELEGATE;
import static com.codeL.mc.agent.fetch.annotation.getter.AnnotationPropertiesGetterUtils.getAnnotationDivideConfig;
import static com.codeL.mc.agent.fetch.annotation.getter.AnnotationPropertiesGetterUtils.getAnnotationValue;
