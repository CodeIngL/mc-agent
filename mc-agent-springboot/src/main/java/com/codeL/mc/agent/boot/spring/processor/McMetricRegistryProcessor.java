package com.codeL.mc.agent.boot.spring.processor;

import com.codeL.mc.agent.boot.spring.actuator.McAgentConfigurationProperties;
 ...
 *         2018/7/10
 */
public class McMetricRegistryProcessor implements BeanPostProcessor, ApplicationContextAware, Ordered {
    ...
    private final List<McAgentConfigurationProperties.McReporterProperties> reporters;

    public McMetricRegistryProcessor(List<McAgentConfigurationProperties.McReporterProperties> reporters) {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        for (McAgentConfigurationProperties.McReporterProperties reporter : reporters) {
    ...
    protected void addDefaultProperties(McAgentConfigurationProperties.McReporterProperties reporterProperties, BeanDefinitionBuilder beanDefBuilder) {
